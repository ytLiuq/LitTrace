...
def evaluate_workspace_against_golden(
    ...
    expected_story = {
        _norm(value) for value in _expected_values(cases, "expected_storyline_claims")
    }
    ...
    _append_missing(
        failures, "source_router", "expected_publishers", expected_publishers, found_publishers
    )
